...
option = form.selectbox('Select the company you want to display stock data', ('Google', 'Apple', 'Microsoft', 'Meta', 'Tesla', 'Amazon'))

period = form.select_slider('Select a frequency of data to display', options=['1 min', '2 mins', '5 mins', '15 mins', '30 mins', '1h', '90 mins', '1 day', '5 days', '1 week', '1 mo', '3 mo'])

col1, col2 = form.columns(2)

start = col1.date_input("""Select the start date (format is yyy-MM-dd)""", datetime.date(2010,1,1))
